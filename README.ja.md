...
| コマンド | 用途 | 状態 |
|---------|------|------|
| `/review:plan` | 実装計画の妥当性評価 | 🚧 開発中 |
| `/review:security` | セキュリティ特化レビュー | ✅ 利用可能 |
| `/review:after` | 実装後の差分レビュー | ✅ 利用可能 |
| `/review:perf` | パフォーマンス分析 | ✅ 利用可能 |
| `/review:deps` | 依存関係とアーキテクチャ評価 | 🚧 開発中 |
| `/review:debt` | 技術的負債の分析 | 🚧 開発中 |
| `/review:patterns` | デザインパターン評価 | 🚧 開発中 |
| `/review:pr` | Pull Request体系的レビュー | 🚧 開発中 |
| `/review:fact` | 情報の正誤確認 | 🚧 開発中 |
