...
**効率的な出力方針**:
- トークン効率化のため、問題が見つからなかったセクションは省略してください
- Critical および High 重大度の問題に重点を置いてください
- **肯定的な側面や優れた実装については出力しないでください**
...
**注意**: 問題が見つからなかった場合は「問題は見つかりませんでした」と明記してください。
...
**注意**: 推奨事項がない場合は、デプロイメント準備状況を記載してください。
...
**注意**: 要件が完全に満たされていない場合、または懸念がある場合のみ含めてください。
...
**注意**: テストカバレッジの問題が特定された場合のみ含めてください。
...
**注意**: デプロイメントに関する懸念が特定された場合のみ含めてください。
...
- **トークン効率化ガイドライン**:
  - **肯定的な側面、良い実践、優れた実装については出力しないでください**
  - 問題や懸念が特定されたセクションのみ出力してください
  - 所見がない任意セクションは省略してください
  - 実行可能な問題と推奨事項に出力を集中させてください
- 徹底性と実用性のバランスを取る
